...
; Dedicated buffer for the debug menu's "Anti-crasher" tool (engine/debug/debug.asm).
; RST $28/$30/$38 jump directly into this buffer, so its contents are executed as
; real Z80 code whenever one of those otherwise-unused RST vectors fires.
hAntiCrashBuffer:: ds 3

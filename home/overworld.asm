...
.AreGuy1
	ld hl, vNPCSprites
	ld b, BANK(RedSprite) ; RedSprite and LeafSprite share a bank
	jr LoadPlayerSpriteGraphicsCommon

LoadSurfingPlayerSpriteGraphics::
	ld de, SeelSprite
	ld hl, vNPCSprites
	ld b, BANK(SeelSprite) ; SeelSprite doesn't share a bank with RedSprite
	jr LoadPlayerSpriteGraphicsCommon
...
.AreGuy2
	ld hl, vNPCSprites
	ld b, BANK(RedBikeSprite) ; RedBikeSprite and LeafBikeSprite share a bank

LoadPlayerSpriteGraphicsCommon::
	ld a, b ; preserve the caller-selected bank across the CopyVideoData call, which clobbers bc
	push af
	push de
	push hl
	ld c, $0c
